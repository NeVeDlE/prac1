...
module.exports = function(Chart) {
	...
	// ItemAdded a reference to each instance - allowing us to globally resize chart instances on window resize.
			...
			if (display) {
				...
				if (isHorizontal) {
					...
					helpers.each(me.legendItems, function(legendItem, i) {
						...
						// ItemAdded the hitbox width and height here. Final position will be updated in `draw`
						hitboxes[i] = {
							left: 0,
							top: 0,
							width: width,
